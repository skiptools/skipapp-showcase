...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://source.skip.tools/skip-device.git", "0.5.3"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-motion.git", "0.7.2"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-notify.git", "0.2.0"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-keychain.git", "0.3.2"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-marketplace.git", "0.4.1"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-authentication-services.git", "0.1.0"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-contacts.git", "0.2.1"..<"2.0.0"),
        .package(url: "https://source.skip.tools/skip-calendar.git", "0.2.0"..<"2.0.0"),
    ],
    targets: [
