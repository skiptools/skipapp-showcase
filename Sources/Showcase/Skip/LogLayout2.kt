 ...
 */
public fun Modifier.logLayoutModifier2(tag: String): Modifier {
    return this then LogLayoutElement2(tag)
}

private class LogLayoutElement2(private val tag: String) : ModifierNodeElement<LogLayoutModifierNode2>() {
    override fun create(): LogLayoutModifierNode2 {
        return LogLayoutModifierNode2(tag)
    }

    override fun update(node: LogLayoutModifierNode2) {
        node.tag = tag
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is LogLayoutElement2) return false
...
private class LogLayoutModifierNode2(
    var tag: String
